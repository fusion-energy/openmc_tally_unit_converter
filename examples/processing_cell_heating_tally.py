...
my_tally = statepoint.get_tally(name="1_heating")
...
result = statepoint.process_tally(
    tally=my_tally, required_units="MeV / simulated_particle"
)
...
statepoint.process_tally(
    source_strength=1e9, tally=my_tally, required_units="MeV / second"
)
